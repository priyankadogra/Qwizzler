...
/**
 * Servlet implementation class UserSuggestionsServlet
 */
public class UserSuggestionsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UserSuggestionsServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			for(int i = 0; i < friends.size(); i++){
				...
				out.println("<br />");
				try {
					out.println("<a href=\"friends.jsp\">" + f.loadFriends().size() + " friends</a>");
